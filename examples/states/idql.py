...
#flags.DEFINE_string("env_name", "Humanoid-v2", "Environment name.")
#flags.DEFINE_string("data_name", "humanoid-medium-v2.pkl", "Environment name.")
...
def call_main(details):
    ...
    ds = ReplayBuffer(
        env.observation_space, env.action_space, int(2e6)
    )
    ds.load("./humanoidData", "500_replay.pkl")
